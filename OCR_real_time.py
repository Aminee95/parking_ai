...
def license_complies_format(text):
    ...
    if all([text[0] in string.digits or text[0] in dict_char_to_int.keys(),
...
def format_license(text):
    ...
    mappings = {
        1: {0: dict_char_to_int, 1: dict_int_to_char, 2: dict_int_to_char, 3: dict_int_to_char, 4: dict_char_to_int, 5: dict_char_to_int}, 
